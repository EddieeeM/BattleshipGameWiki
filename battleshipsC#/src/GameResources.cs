...
public static class GameResources
{
    ...
    NewImage("Menu", "home.jpg");   //new Main Menu Image - Long
    ...
    NewSound("OhNo", "ohno.wav"); // new Losing Sound - Henry
    NewSound("Explosion", "explosion.wav"); // Added explosion Sound - Eddie
	}

	private static void LoadMusic()
	{
		NewMusic("Background1", "horrordrone.mp3");   //More BG Music Added
    NewMusic("Background2", "newBGMusic.wav");
	}
