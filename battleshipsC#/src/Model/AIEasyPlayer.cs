...
public class AIEasyPlayer : AIPlayer
{
		...
		do {
			...
			switch (_CurrentState) {
				...
				case AIStates.TargetingShip:
					//TargetCoords(ref row, ref column);		//TargetCords Not Used - Randomised; Eddie
					SearchCoords(ref row, ref column);
					break;
				default:
	...
	/// <summary>
	/// TargetCoords is used when a ship has been hit and it will try and destroy	//TargetCords Not Used - Randomised; Eddie
	/// this ship
	/// </summary>
